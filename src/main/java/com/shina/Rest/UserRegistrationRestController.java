...
import com.shina.Exception.CustomErrorType;
import com.shina.dto.UserDTO;
import com.shina.repository.UserJpaRepository;
...
public class UserRegistrationRestController {
	...
	public ResponseEntity<UserDTO> updateUser(@PathVariable("id") final Long id, @RequestBody UserDTO user){
		...
		// fetch user base on id and set it to current user object of type UserDTO
...
//		userJpaRepository.deleteById(currentId);
